var relearn_search_index = [
  ...
  },
  {
    ...
    "tags": null,
    "title": "Child 0 0",
    "uri": "/skill/grammar/child-0/child-0-0/index.html"
  },
  {
    "breadcrumb": "Skill \u003e Grammar",
    "content": "child-0\n",
    "description": "custom 0",
    "tags": null,
    "title": "Child 0",
    "uri": "/skill/grammar/child-0/index.html"
  },
  {
    "breadcrumb": "Skill",
    "content": "Hugo \u0026 RelearnTheme 使用 创建Blog hugo new site \u003cnew_project\u003e 使用 hugo-theme-relearn git submodule add https://github.com/McShelby/hugo-theme-relearn.git themes/hugo-theme-relearn 创建一级章节 hugo new --kind chapter \u003cchapter_title_first\u003e/_index.md 创建二级章节 hugo new \u003cchapter_title_first\u003e/\u003cchapter_title_second\u003e/_index.md 服务测试运行 hugo serve 博客生成 hugo配置 CONFIGURATION BRANDING CUSTOMIZATION FRONTMATTER TOPBAR MODIFICATION ARCHETYPES IMAGE EFFECTS MENU EXTRA SHORTCUTS MULTILINGUAL AND I18N TAXONOMY ATTACHMENTS HIGHLIGHT MATH MERMAID OPENAPI SITEPARAM 跳转 标题没有索引 标题自定义索引 跳转页面 跳转本地标题 跳转其他页面标题 文本链接\nIt’s a head portrait\nDump picture Uri Download variant Reset variant\nBUTTON CustomTagLink1NoIndicator CustomTagLink2WithIndicator Footnote11 Footnote22\n文本 高亮 粗体 斜体 删除线\naaa bbb ccc 引用aaaaaaaaaa\n引用bbbbbbbb\n引用cccccccccc\n引用dddddd\nLrain\nExpand me…\rNo title\nCustom title\rCustom title\nSystem.out.println(\"Hello world\")\r​\rHello.java\rSystem.out.println(\"Hello world\")\raaaaaaaaaaa bbbbbbb System.out.println(\"Hello world\") aaaaaaaaaaa bbbbbbbb cccccccc System.out.println(\"Hello world\") hello\rjava\rkt\rc\rSystem.out.println(\"Hello world\");\rprintln(\"Hello world\")\rprintf(\"Hello world\\n\");\rrow1 row2 row3 col1 cr cr cr col2 cr cr cr col3 cr cr cr aaaaaaa bbbbb ccccccc ddddd simple code style\nline 1 of code line 2 of code line 3 of code custom code 1 custom code 2 custom code 3\rNote\rnote\nTip\rtip\nInfo\rinfo\nWarning\rwarning\nResult\rresult1\nresult2\nThere may be pirates\rIt is all about the boxes.\nWarning, no icon, no title\nHere are dragons\rA warning disclaimer\nAn accent disclaimer\nA blue disclaimer\nGreen\rA green disclaimer\nA grey disclaimer\nPay Attention to this Note!\rSome serious information.\nPay Attention to this Note!\rSome serious information.\nHugo\rVictor? Is it you?\n图标 0.112.4 Breaking Change New ICON BADGE 目录 // page的配置 +++ title = 'Child x x' date = 2024-02-17T17:12:24+08:00 weight = x draft = false description = \"custom x x\" alwaysopen = false hidden = true [_build] render = \"never\" +++\rChild 0custom 0\nChild 0 1\nChild 1child-1\nChild 1 0custom 1 0\nChild 1 1child-1-1 child-1-1 child-1-1 h1 h2 Child 0custom 0\nChild 0 0\nChild 0 1\nChild 1child-1\nChild 1 0custom 1 0\nChild 1 1child-1-1 child-1-1 child-1-1 h1 h2 Child 0custom 0\nChild 0 1\nChild 1child-1\nChild 1 0custom 1 0\nChild 1 1child-1-1 child-1-1 child-1-1 h1 h2 引用 關關雎鳩、在河之洲。 窈窕淑女、君子好逑。 參差荇菜、左右流之。 窈窕淑女、寤寐求之。 求之不得、寤寐思服。 悠哉悠哉、輾轉反側。 參差荇菜、左右采之。 窈窕淑女、琴瑟友之。 參差荇菜、左右芼之。 窈窕淑女、鍾鼓樂之。\nMessage1 ↩︎\nMessage2 ↩︎\n",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Child 0 1",
    "uri": "/skill/grammar/child-0/child-0-1/index.html"
  },
  {
    "breadcrumb": "Skill \u003e Grammar \u003e Child 1",
    "content": "child-1-1\nchild-1-1\nchild-1-1\nh1 h2 ",
    "description": "",
    "tags": null,
    "title": "Child 1 1",
    "uri": "/skill/grammar/child-1/child-1-1/index.html"
  },
  {
    "breadcrumb": "Skill \u003e Grammar",
    "content": "child-1\n",
    ...
    "tags": null,
    "title": "Child 1",
    "uri": "/skill/grammar/child-1/index.html"
  },
  {
    "breadcrumb": "",
  ...
  },
  {
    ...
    "tags": null,
    "title": "Category :: data",
    "uri": "/categories/data/index.html"
  },
  {
    "breadcrumb": "Tags",
